...
import { buildEditorialPromotion } from '../scripts/build-editorial-promotion.mjs';
...
test('builds a blocked_media record only from an approved exact draft revision', () => {
  const record = buildEditorialPromotion({ promotion, draft, draftPath: promotion.draft_path, draftSha, now: '2026-09-25T00:02:00Z' });
