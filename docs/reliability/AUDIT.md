...
4. **P1: observabilidad y evidencia de runtime.** Health Watch está activo, horario y de solo lectura. La auditoría del 25 de septiembre confirmó Worker, versión con 100% de tráfico, handler `scheduled`, cron presente, bindings, secretos por nombre, logs al 100% y ausencia de queue consumers. Falta comparar el bundle productivo y los alcances efectivos de credenciales. Ver [auditoría de runtime](PRODUCTION_RUNTIME_AUDIT-2026-09-25.md).
